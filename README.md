...
This project is built using [Astro](https://astro.build/) and [Tailwind CSS](https://tailwindcss.com/), ensuring a fast and responsive user experience.

## License

This project is licensed under the [GPL-3.0 License](https://github.com/HomeworkSMP/website?tab=GPL-3.0-1-ov-file#). For more details, refer to the [LICENSE](LICENSE) file.
...
2. Ensure [Node.js](https://nodejs.org) is installed on your system.
